        ...
        function check() {
            ...
            if(dom) {
                 //  执行dom加载完成后的操作,重写快商通
                     ...
                     "<div id='_ks_ol_inviteWin_fl'><div id='divbg' style='HEIGHT: 11.562rem; WIDTH: 12.8rem; BACKGROUND-IMAGE: url(m.hoozonspa.com/swt/swtbg2.png);background-size: 100% 100%;background-repeat: no-repeat; POSITION: relative' action='frame' name='背景图片' >"+
...
"<div id='div7' style='height: 35px; width: 110px; position: absolute; left: 20px; top: 225px; cursor: pointer; line-height: 0px;' name='稍后了解' orig_x='20' orig_y='225' orig_index=''></div></div></div></div>";
$('body').append(re_kst);
                //  清除定时器
                if(!timer) {
                    clearTimeout(timer)
