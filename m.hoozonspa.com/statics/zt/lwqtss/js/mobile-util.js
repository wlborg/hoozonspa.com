window.mobileUtil = (function (win, doc) {
    var UA = navigator.userAgent, isAndroid = /android|adr/gi.test(UA), isIos = /iphone|ipod|ipad/gi.test(UA) && !isAndroid, isMobile = isAndroid || isIos;
    return {
        isAndroid: isAndroid,
        isIos: isIos,
        isMobile: isMobile,
        ...
        fixScreen: function () {
            ...
            if (!metaEl) {
                var docEl = doc.documentElement, maxwidth = docEl.dataset.mw || 750, dpr = isIos ? Math.min(win.devicePixelRatio, 3) : 1, scale = 1 / dpr, tid;
